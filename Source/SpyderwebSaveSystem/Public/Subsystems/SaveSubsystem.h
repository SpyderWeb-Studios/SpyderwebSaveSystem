...
class SPYDERWEBSAVESYSTEM_API USaveSubsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()
public:
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "Save System", meta = (DeterminesOutputType = "SaveGameClass"))
